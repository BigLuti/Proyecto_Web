...
<div class="product-item bg-light">
	<div class="card">
		...
		<div class="card-body">
		    <h4 class="card-title"><a href="">Jeep Wrangler</a></h4>
		    <ul class="list-inline product-meta">
		    	<li class="list-inline-item">
		    		<a href=""><i class="fa fa-folder-open-o"></i>Jeep</a>
		    	</li>
		    	<li class="list-inline-item">
		    		<a href=""><i class="fa fa-calendar"></i>23 de Agosto</a>
		    	</li>
		    </ul>
		    <p class="card-text">Auto especial para terrenos irregulares, perfecto para una buena excursion!</p>
